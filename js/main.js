// COMPONENT DATA
const COMPONENTS=[
{cat:'Primitives',id:'prim-rectangle',name:'Rectangle',file:'components/prim-rectangle.php',icon:'M4 4h16v16H4z',isPrim:true},
{cat:'Primitives',id:'prim-circle',name:'Circle',file:'components/prim-circle.php',icon:'M12 2a10 10 0 100 20 10 10 0 000-20z',isPrim:true},
{cat:'Primitives',id:'prim-text',name:'Text Block',file:'components/prim-text.php',icon:'M4 7V4h16v3M9 20h6M12 4v16',isPrim:true},
{cat:'Primitives',id:'prim-heading',name:'Heading',file:'components/prim-heading.php',icon:'M4 12h8m-8-4v8m8-8v8M16 6v12',isPrim:true},
{cat:'Primitives',id:'prim-button',name:'Button',file:'components/prim-button.php',icon:'M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5',isPrim:true},
{cat:'Primitives',id:'prim-input',name:'Input Field',file:'components/prim-input.php',icon:'M4 7h16v10H4zM7 12h3',isPrim:true},
{cat:'Primitives',id:'prim-image',name:'Image',file:'components/prim-image.php',icon:'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586',isPrim:true},
{cat:'Primitives',id:'prim-video',name:'Video',file:'components/prim-video.php',icon:'M15 10l4.553-2.276A1 1 0 0121 8.618v6.764',isPrim:true},
{cat:'Primitives',id:'prim-map',name:'Map',file:'components/prim-map.php',icon:'M17.657 16.657L13.414 20.9a2 2 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z',isPrim:true},
{cat:'Primitives',id:'prim-icon',name:'Icon',file:'components/prim-icon.php',icon:'M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77',isPrim:true},
{cat:'Primitives',id:'prim-line',name:'Line / Divider',file:'components/prim-line.php',icon:'M5 12h14',isPrim:true},
{cat:'Primitives',id:'prim-container',name:'Container (Flex)',file:'components/prim-container.php',icon:'M4 4h16v16H4zM4 8h16',isPrim:true},
{cat:'Primitives',id:'prim-iframe',name:'Iframe / Embed',file:'components/prim-iframe.php',icon:'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4',isPrim:true},
{cat:'Primitives',id:'prim-table',name:'Table (Custom)',file:'components/prim-table.php',icon:'M3 10h18M3 14h18M3 6h18v12H3z',isPrim:true,isTable:true},
{cat:'General',id:'accordion',name:'Accordion',file:'components/accordion.php',icon:'M19 9l-7 7-7-7'},
{cat:'General',id:'alert',name:'Alert',file:'components/alert.php',icon:'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z'},
{cat:'General',id:'avatar',name:'Avatar',file:'components/avatar.php',icon:'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'},
{cat:'General',id:'badge',name:'Badge',file:'components/badge.php',icon:'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7'},
{cat:'General',id:'button',name:'Button Group',file:'components/button.php',icon:'M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5'},
{cat:'General',id:'card',name:'Card',file:'components/card.php',icon:'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5z'},
{cat:'General',id:'carousel',name:'Carousel',file:'components/carousel.php',icon:'M4 16l4.586-4.586a2 2 0 012.828 0L16 16'},
{cat:'General',id:'chat',name:'Chat',file:'components/chat.php',icon:'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6'},
{cat:'General',id:'collapse',name:'Collapse',file:'components/collapse.php',icon:'M19 13l-7 7-7-7m14-8l-7 7-7-7'},
{cat:'General',id:'datepicker',name:'Datepicker',file:'components/datepicker.php',icon:'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7'},
{cat:'General',id:'divider',name:'Divider',file:'components/divider.php',icon:'M5 12h14'},
{cat:'General',id:'list',name:'List Group',file:'components/list.php',icon:'M4 6h16M4 10h16M4 14h16M4 18h16'},
{cat:'General',id:'progress',name:'Progress',file:'components/progress.php',icon:'M13 10V3L4 14h7v7l9-11h-7z'},
{cat:'General',id:'skeleton',name:'Skeleton',file:'components/skeleton.php',icon:'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7'},
{cat:'General',id:'spinner',name:'Spinner',file:'components/spinner.php',icon:'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9'},
{cat:'General',id:'stepper',name:'Stepper',file:'components/stepper.php',icon:'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10'},
{cat:'General',id:'timeline',name:'Timeline',file:'components/timeline.php',icon:'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'},
{cat:'General',id:'typography',name:'Typography',file:'components/typography.php',icon:'M4 6h16M4 12h16m-7 6h7'},
{cat:'Navigation',id:'breadcrumb',name:'Breadcrumb',file:'components/breadcrumb.php',icon:'M9 5l7 7-7 7'},
{cat:'Navigation',id:'navbar',name:'Navbar',file:'components/navbar.php',icon:'M4 6h16M4 12h16M4 18h16'},
{cat:'Navigation',id:'tabs',name:'Tabs',file:'components/tabs.php',icon:'M5 12h14M5 12a2 2 0 01-2-2V6'},
{cat:'Navigation',id:'pagination',name:'Pagination',file:'components/pagination.php',icon:'M7 16l-4-4m0 0l4-4m-4 4h18'},
{cat:'Navigation',id:'sidebar-c',name:'Sidebar',file:'components/sidebar.php',icon:'M9 17V7m0 10a2 2 0 01-2 2H5'},
{cat:'Forms',id:'checkbox',name:'Checkbox/Radio',file:'components/checkbox.php',icon:'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'},
{cat:'Forms',id:'input',name:'Input',file:'components/input.php',icon:'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11'},
{cat:'Forms',id:'select',name:'Select',file:'components/select.php',icon:'M19 9l-7 7-7-7'},
{cat:'Forms',id:'switch',name:'Switch',file:'components/switch.php',icon:'M8 7h8a4 4 0 110 8H8a4 4 0 110-8z'},
{cat:'Forms',id:'form-full',name:'Form',file:'components/form.php',icon:'M3 8l7.89 5.26a2 2 0 002.22 0L21 8'},
{cat:'Overlays',id:'dropdown',name:'Dropdown',file:'components/dropdown.php',icon:'M19 9l-7 7-7-7'},
{cat:'Overlays',id:'modal',name:'Modal',file:'components/modal.php',icon:'M8 7V5a2 2 0 012-2h4a2 2 0 012 2v2M3 19v-8a2 2 0 012-2h14'},
{cat:'Overlays',id:'tooltip',name:'Tooltip',file:'components/tooltip.php',icon:'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0'},
{cat:'Data',id:'table',name:'Table',file:'components/table.php',icon:'M3 10h18M3 14h18m-9-4v8'},
{cat:'Data',id:'charts',name:'Charts',file:'components/charts.php',icon:'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2z'},
{cat:'Sections',id:'hero',name:'Hero',file:'components/hero.php',icon:'M4 16l4.586-4.586a2 2 0 012.828 0L16 16'},
...
const layersList=document.getElementById('layers-list'),tabComp=document.getElementById('tab-btn-comp'),tabLayers=document.getElementById('tab-btn-layers');
const rpIntSec=document.getElementById('rp-interaction-section'),rpLinkTarget=document.getElementById('rp-link-target');
...
tabComp.addEventListener('click',()=>{
    tabComp.className='flex-1 py-2 text-[10px] font-bold uppercase tracking-wider text-[var(--accent)] border-b-2 border-[var(--accent)]';
    tabLayers.className='flex-1 py-2 text-[10px] font-bold uppercase tracking-wider text-[var(--text-muted)] hover:text-[var(--text-primary)]';
    compList.style.display='block';layersList.style.display='none';
});
tabLayers.addEventListener('click',()=>{
    tabLayers.className='flex-1 py-2 text-[10px] font-bold uppercase tracking-wider text-[var(--accent)] border-b-2 border-[var(--accent)]';
    tabComp.className='flex-1 py-2 text-[10px] font-bold uppercase tracking-wider text-[var(--text-muted)] hover:text-[var(--text-primary)]';
...
async function addComponent(comp,container,before=null){
    let html='';
    if(comp.file){try{const v=Date.now();const r=await fetch(comp.file+'?v='+v);if(!r.ok)throw 0;html=await r.text();}catch{html=`<div style="padding:12px;border:2px dashed #94a3b8;color:#94a3b8;font-size:10px;">[${comp.name}]</div>`;}}
...
function setupComponentEvents(ci, comp, dz) {
    ...
    let resizerR = ci.querySelector('.resizer-r');
    if(!resizerR){resizerR=document.createElement('div');resizerR.className='resizer-r';ci.appendChild(resizerR);}
    let resizerB = ci.querySelector('.resizer-b');
    if(!resizerB){resizerB=document.createElement('div');resizerB.className='resizer-b';ci.appendChild(resizerB);}

    const startResize = (e, mode) => {
        e.preventDefault();e.stopPropagation();
        const startX=e.clientX,startY=e.clientY,startW=ci.offsetWidth,startH=ci.offsetHeight;
        const move=(me)=>{
            if(mode==='corner' || mode==='right'){ const nw=startW+(me.clientX-startX)/currentZoom; ci.style.width=nw+'px'; }
            if(mode==='corner' || mode==='bottom'){ const nh=startH+(me.clientY-startY)/currentZoom; ci.style.height=nh+'px'; }
    ...
    resizer.addEventListener('mousedown',e=>startResize(e,'corner'));
    resizerR.addEventListener('mousedown',e=>startResize(e,'right'));
    resizerB.addEventListener('mousedown',e=>startResize(e,'bottom'));
}
...
function toggleGuide(){guideModal.classList.toggle('open');}
...
document.getElementById('btn-close-guide')?.addEventListener('click',toggleGuide);
document.getElementById('btn-read-full')?.addEventListener('click',toggleGuide);
...
// UTILS
function updateStatus(){if(!statusEl)return;const count=document.querySelectorAll('.ci').length;statusEl.innerHTML=`<span class="status-dot"></span> ${count} item${count!==1?'s':''} on canvas`;renderLayers();}
function showEmpty(dz){const es=dz.querySelector('.empty-state');if(es)es.style.display=dz.querySelector('.ci')?'none':'flex';renderLayers();}

// PROTOTYPE ENGINE
btnPlayMode.addEventListener('click',enterPlayMode);
btnExitPlay.addEventListener('click',exitPlayMode);
btnCloseOverlay.addEventListener('click',()=>prototypeOverlay.classList.remove('active'));

function enterPlayMode(){
    if(!screens.length)return;
    saveCurrentScreen();isPlaying=true;
    document.getElementById('left-panel').style.display='none';
    document.getElementById('right-panel').style.display='none';
    document.getElementById('toolbar').style.display='none';
    document.getElementById('screen-tabs').style.display='none';
...
function exitPlayMode(){
    ...
    document.getElementById('screen-tabs').style.display='flex';
...
// Global click handler for playing
